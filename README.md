...
Bug reports and pull requests are welcome on GitHub at https://github.com/[USERNAME]/dock_health_api. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [code of conduct](https://github.com/[USERNAME]/dock_health_api/blob/master/CODE_OF_CONDUCT.md).
